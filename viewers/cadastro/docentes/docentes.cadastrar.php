...
<section class="row">
	...
	<section class="col-md-4">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="nome_docente" placeholder="Nome" aria-describedby="basic-addon1">
        </div>
    </section>
    ...
    <section class="col-md-4">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="siape_docente" placeholder="1234567" aria-describedby="basic-addon1">
        </div>
    </section>
    ...
    <section class="col-md-4">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="email_docente" placeholder="exemplo@email.com" aria-describedby="basic-addon1">
        </div>
    </section>
</section>
...
<section class="row">
	...
	<section class="col-md-4">
		<div class="input-group">
          ...
          <input type="text" class="form-control" id="efetivo_placeholder" disabled placeholder="Escolha uma opção" aria-describedby="basic-addon1">
        </div><!-- /input-group -->
    </section>
