...
?>
          ...
          <input id="id_curso" type="hidden" value="<?php echo $Item['id_curso']?>">
          <input type="text" class="form-control" id="curso_placeholder" disabled placeholder="<?php foreach($Curso as $LinhaCurso){if($Item['id_curso'] === $LinhaCurso['id_curso']){echo $LinhaCurso['nome_curso']; break;}}?>" aria-describedby="basic-addon1">
        </div><!-- /input-group -->
    </section>
