...
<script>
	$(document).ready(function(e) {
		...
		$('#Salvar').click(function(e) {
			...
			var id_treinador = $('#id_treinador').val();
...
<section class="row formAdicionarDados">
	<section class="col-md-4">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="dtcadastro_treinador"  placeholder="Data de Cadastro" aria-describedby="basic-addon1" value="<?php echo ExibeData($Item['dtcadastro_treinador']);?>">
        </div>
    </section>
    <section class="col-md-4">
    	<div class="input-group">
