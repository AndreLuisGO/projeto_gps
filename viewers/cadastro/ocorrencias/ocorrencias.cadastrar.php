...
<section class="row">
	...
	<section class="col-md-8">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="tipo_ocorrencia" placeholder="Tipo de Ocorrência" aria-describedby="basic-addon1">
        </div>
    </section>
    ...
    <section class="col-md-4">
    	<div class="input-group">
          ...
          <input type="text" class="form-control" id="codigo_ocorrencia" placeholder="01-234" aria-describedby="basic-addon1">
        </div>
    </section>
</section>