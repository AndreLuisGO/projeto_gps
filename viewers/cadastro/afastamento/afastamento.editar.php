...
<?php
				...
				foreach ( $Docente as $docenteRow ) {
					// var_dump($DocenteRow);
					?>
						    <li><a href="#" id=<?php echo $docenteRow['id_docente']; ?>
							class="docente_select">
		...
		<?php
			...
			?>
				...
				<!-- /btn-group -->
				<input id="id_docente" type="hidden"> <input type="text"
					class="form-control" id="docente_placeholder" disabled
					placeholder="Escolha um docente" aria-describedby="basic-addon1">
			</div>
			<!-- /input-group -->
		...
		<section class="col-md-4">
			<div class="input-group">
				<div class="input-group-btn">
					<button type="button" class="btn btn-default dropdown-toggle"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						Ocorrência <span class="caret"></span>
					</button>
					<ul class="dropdown-menu"> 
		<?php
...
<?php
			...
			foreach ( $Ocorrencia as $ocorrenciaRow ) {
				...
				?>
				    <li><a href="#"
							id=<?php echo $ocorrenciaRow['id_ocorrencia']; ?>
							class="ocorrencia_select">
...
<?php
		...
		?>
				...
				<!-- /btn-group -->
				<input id="id_ocorrencia" type="hidden"> <input type="text"
					class="form-control" id="ocorrencia_placeholder" disabled
					placeholder="Ocorrência" aria-describedby="basic-addon1">
			</div>
			<!-- /input-group -->
		</section>
