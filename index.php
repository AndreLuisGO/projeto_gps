	...
	<nav class="navbar-sistema navbar navbar-fixed-top ">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" id="">Sistema de </a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#" id=""></a></li>
                <li><a href="#" id="cadastro_treinador_link">Treinador</a></li>
                <li><a href="#" id="">Treinamento</a></li>
              </ul>
            </li>
             ...
             <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="#" id="">Aula</a></li>
                <li><a href="#" id="">Turma</a></li>
              </ul>
            </li>
